...
public class CustomerRegistry implements Serializable{
    ...
    private String name;
//�п����ж���������û����÷ֺŸ���    
    private String reliedCustomerName;
    ...
    public CustomerRegistry(String name) {
        ...
        this.setUtilizationProfile(new UtilizationProfile());
...
//        this.utilizationProfile = new UtilizationProfile();
    ...
    public String getReliedCustomerName() {
		return reliedCustomerName;
	}

	public void setReliedCustomerName(String reliedCustomerName) {
		this.reliedCustomerName = reliedCustomerName;
	}
