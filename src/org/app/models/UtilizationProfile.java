...
public class UtilizationProfile implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4902952064111806249L;
    ...
    public UtilizationProfile() {
        ...
        this.setTimeToSend(0);
        setUtilizationModelCpuAlias("Full");
        setUtilizationModelRamAlias("Full");
        setUtilizationModelBwAlias("Full");
    }
    public UtilizationProfile(String broker,int numberofCloudlets,long length,
    			long fileSize,long outputSize,String cpuModel,String ramModel,String bwModel) {
    	 this.setTimeToSend(0);
    	setBrokerPolicyAlias(broker);
        setTimeZone(-3.0);
        setNumOfCloudlets(numberofCloudlets);
        setLength(length);
        setFileSize(fileSize);
        setOutputSize(outputSize);
        setCloudletsPesNumber(1);
        setUtilizationModelCpuAlias(cpuModel);
        setUtilizationModelRamAlias(ramModel);
        setUtilizationModelBwAlias(bwModel);
    }
