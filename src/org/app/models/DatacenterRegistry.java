...
public class DatacenterRegistry implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3942296395482953338L;
 ...
 //       setAllocationPolicyAlias("SimpleTest");
        setVmMigration(true);
        setCostPerSec(0.1);
        setCostPerMem(0.05);
        ...
        //Create host list
        List<HostRegistry> li = new ArrayList<HostRegistry>();
        for(int i = 0; i < 3; ++i){
        	li.add(new HostRegistry());
        }
        setHostList(li);
