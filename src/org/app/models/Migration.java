...
public class Migration {
    ...
    /** The source host. */
    private NetPowerHost sourceHost;    
    
    /** The target host. */
    private NetPowerHost targetHost;
     ...
     * @since                       1.0
     */        
    public Migration(VmAllocationPolicy vmAllocationPolicy, NetPowerHost targetHost, NetPowerHost sourceHost, Vm vm, int currentSimulation) {
     ...
     */
    public NetPowerHost getTargetHost() {
        return targetHost;
    }
     ...
     */
    public void setTargetHost(NetPowerHost targetHost) {
        this.targetHost = targetHost;
    }
     ...
     */
    public NetPowerHost getSourceHost() {
        return sourceHost;
    }
     ...
     */
    public void setSourceHost(NetPowerHost sourceHost) {
        this.sourceHost = sourceHost;
    }
