...
public class VirtualMachineRegistry implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4721354585694468067L;
    ...
    public void clone(VirtualMachineRegistry b){
    	this.amount=b.amount;
    	this.bw=b.bw;
    	this.hostId=b.hostId;
    	this.mips=b.mips;
    	this.pesNumber=b.pesNumber;
    	this.priority=b.priority;
    	this.ram=b.ram;
    	this.schedulingPolicyAlias=b.schedulingPolicyAlias;
    	this.size=b.size;
    	this.vmm=b.vmm; 	
    }
    /**
    ...
    public String toString() {
        ...
        s.append("VM hostid="+this.getHostId()+"\n");
