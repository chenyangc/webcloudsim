/* 
 * Copyright (c) 2010-2012 Thiago T. S谩
 * 
...
//        ClassLoader classLoader = FileIO.class.getClassLoader();
        InputStream resourceStream = FileIO.class.getResourceAsStream(filePath);
...
//        InputStream resourceStream = FileIO.class.getResourceAsStream("log/log.txt");
